...
@Component({
  selector: 'app-action-creators',
  templateUrl: './action-creators.component.html',
  styleUrls: ['./action-creators.component.css']
})
export class ActionCreatorsComponent implements OnInit {
  constructor() {}
